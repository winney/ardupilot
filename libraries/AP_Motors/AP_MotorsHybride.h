...
#define MOTORSHYBRIDE_HYBR_MIX_MODE_DEFAULT 1

#define MOTORSHYBRIDE_HYBR_ICE_RATE_DEFAULT 1
...
public:
    ...
    /// Constructor
    AP_MotorsHybride(uint16_t loop_rate, uint16_t speed_hz = AP_MOTORS_SPEED_DEFAULT) :
